...
<section className=" min-[1920px]:h-fit 2xl:h-fit flex items-center justify-center bg-gradient-to-r
    ...
    <motion.div
    className="w-full 2xl:m-28  2xl:mt-0 min-[1920px]:m-60 min-[1920px]:mt-0 min-[1920px]:mb-0 md:m-40 md:mb-2 md:mt-0"
    ...
    >
        <div className="relative">
            <div className={`toggle ${isActive ? "relative h-fit overflow-hidden grid grid-cols-2 gap-4 flex relative" :  "relative h-[47rem] overflow-hidden grid grid-cols-2 gap-4 flex relative" }`}>
                <div className="relative">
...
<section className=" min-[1920px]:h-fit 2xl:h-fit flex items-center justify-center bg-gradient-to-r
    ...
    <div className="lg:flex inline-flex items-center justify-center m-4">
